...
class AtlasVideoEffectsGenderSwap:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Gender Swap": AtlasVideoEffectsGenderSwap}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Gender Swap": "AtlasCloud Gender Swap"}
