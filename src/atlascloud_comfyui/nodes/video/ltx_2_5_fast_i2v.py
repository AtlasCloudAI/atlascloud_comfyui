...
class AtlasLtx25FastImageToVideo:
    """
    ComfyUI Node: AtlasCloud LTX 2.5 Fast Image-to-Video (remote API)
    ...
    def run(
        ...
        if not image:
            raise RuntimeError("image is required for LTX 2.5 Fast Image-to-Video")

        client = atlas_client.client

        payload: Dict[str, Any] = {
            "model": "ltx/ltx-2.5-fast/image-to-video",
            "image": image,
