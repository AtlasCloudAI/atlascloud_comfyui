...
class AtlasVideoEffectsFrenchKiss:
    ...
    def run(
        ...
        payload = {
            "model": "video-effects/french-kiss",
...
NODE_CLASS_MAPPINGS = {"AtlasCloud French Kiss": AtlasVideoEffectsFrenchKiss}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud French Kiss": "AtlasCloud French Kiss"}
