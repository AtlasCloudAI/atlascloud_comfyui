...
class AtlasAlibabaWan21I2v720p:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.1/i2v-720p",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 720p": AtlasAlibabaWan21I2v720p}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 720p": "AtlasCloud Wan-2.1 i2v 720p"}
