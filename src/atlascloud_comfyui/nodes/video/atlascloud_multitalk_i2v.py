...
class AtlasAtlascloudMultitalk:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Multitalk": AtlasAtlascloudMultitalk}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Multitalk": "AtlasCloud Multitalk"}
