...
class AtlasMinimaxHailuo02T2vPro:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hailuo-02 t2v Pro": AtlasMinimaxHailuo02T2vPro}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hailuo-02 t2v Pro": "AtlasCloud Hailuo-02 t2v Pro"}
