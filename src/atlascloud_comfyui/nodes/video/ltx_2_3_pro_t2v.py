...
class AtlasLtx23ProTextToVideo:
    """
    ComfyUI Node: AtlasCloud LTX 2.3 Pro Text-to-Video (remote API)
    ...
    def run(
        ...
        if not prompt:
            raise RuntimeError("prompt is required for LTX 2.3 Pro Text-to-Video")

        client = atlas_client.client

        payload: Dict[str, Any] = {
            "model": "ltx/ltx-2.3-pro/text-to-video",
            "prompt": prompt,
