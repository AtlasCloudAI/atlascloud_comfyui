...
class AtlasLightricksLtx2ProImageToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "duration": ([6, 8, 10], {"default": 6, "tooltip": "The duration of the generated media in seconds."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Ltx-2 Pro Image-to-video": AtlasLightricksLtx2ProImageToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Ltx-2 Pro Image-to-video": "AtlasCloud Ltx-2 Pro Image-to-video"}
