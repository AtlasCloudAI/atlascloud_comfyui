...
class AtlasKwaivgiKlingV26StdMotionControl:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Kling v2.6 Std Motion Control": AtlasKwaivgiKlingV26StdMotionControl}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Kling v2.6 Std Motion Control": "AtlasCloud Kling v2.6 Std Motion Control"}
