...
class AtlasVideoEffectsShakeDance:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Shake Dance": AtlasVideoEffectsShakeDance}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Shake Dance": "AtlasCloud Shake Dance"}
