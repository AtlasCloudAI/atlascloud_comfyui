...
class AtlasBytedanceLipsyncAudioToVideo:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Lipsync Audio-to-video": AtlasBytedanceLipsyncAudioToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Lipsync Audio-to-video": "AtlasCloud Lipsync Audio-to-video"}
