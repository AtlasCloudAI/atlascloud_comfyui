...
class AtlasAtlascloudVan26ImageToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "duration": ([5, 10, 15], {"default": 5, "tooltip": "The duration of the generated media in seconds."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Van-2.6 Image-to-video": AtlasAtlascloudVan26ImageToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Van-2.6 Image-to-video": "AtlasCloud Van-2.6 Image-to-video"}
