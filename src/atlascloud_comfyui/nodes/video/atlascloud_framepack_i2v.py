...
class AtlasAtlascloudFramepack:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Framepack": AtlasAtlascloudFramepack}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Framepack": "AtlasCloud Framepack"}
