...
NODE_CLASS_MAPPINGS = {"AtlasCloud Vidu Reference-to-Video Q1": AtlasViduReferenceToVideoQ1}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Vidu Reference-to-Video Q1": "AtlasCloud Vidu Reference-to-Video Q1"}
