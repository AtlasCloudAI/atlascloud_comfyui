...
class AtlasBytedanceAvatarOmniHuman:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Avatar Omni Human": AtlasBytedanceAvatarOmniHuman}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Avatar Omni Human": "AtlasCloud Avatar Omni Human"}
