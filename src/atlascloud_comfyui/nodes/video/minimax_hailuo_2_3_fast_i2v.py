...
class AtlasMinimaxHailuo23Fast:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hailuo-2.3 Fast": AtlasMinimaxHailuo23Fast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hailuo-2.3 Fast": "AtlasCloud Hailuo-2.3 Fast"}
