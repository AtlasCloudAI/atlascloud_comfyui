...
class AtlasAlibabaWan22T2v5b720pLora:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.2/t2v-5b-720p-lora",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.2 t2v 5b 720p Lora": AtlasAlibabaWan22T2v5b720pLora}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.2 t2v 5b 720p Lora": "AtlasCloud Wan-2.2 t2v 5b 720p Lora"}
