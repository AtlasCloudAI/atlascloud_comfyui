...
class AtlasMinimaxHailuo02I2vPro:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "prompt": ("STRING", {"multiline": True, "default": "", "tooltip": "Generate a description of the video.(Note: Maximum support 2000 characters)."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hailuo 02 i2v Pro": AtlasMinimaxHailuo02I2vPro}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hailuo 02 i2v Pro": "AtlasCloud Hailuo 02 i2v Pro"}
