...
NODE_CLASS_MAPPINGS = {"AtlasCloud Pika v2.0 Turbo t2v": AtlasPikaV20TurboT2v}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Pika v2.0 Turbo t2v": "AtlasCloud Pika v2.0 Turbo t2v"}
