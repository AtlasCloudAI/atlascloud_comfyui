...
class AtlasVideoEffectsLoveDrop:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Love Drop": AtlasVideoEffectsLoveDrop}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Love Drop": "AtlasCloud Love Drop"}
