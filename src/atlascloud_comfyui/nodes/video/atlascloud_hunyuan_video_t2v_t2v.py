...
class AtlasAtlascloudHunyuanVideoT2v:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hunyuan Video t2v": AtlasAtlascloudHunyuanVideoT2v}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hunyuan Video t2v": "AtlasCloud Hunyuan Video t2v"}
