...
class AtlasAlibabaWan25VideoExtendFast:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "duration": ([3, 4, 5, 6, 7, 8, 9, 10], {"default": 5, "tooltip": "The duration of the generated media in seconds."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.5 Video Extend Fast": AtlasAlibabaWan25VideoExtendFast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.5 Video Extend Fast": "AtlasCloud Wan-2.5 Video Extend Fast"}
