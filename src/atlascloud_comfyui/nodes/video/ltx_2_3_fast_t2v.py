...
class AtlasLtx23FastTextToVideo:
    """
    ComfyUI Node: AtlasCloud LTX 2.3 Fast Text-to-Video (remote API)
    ...
    def run(
        ...
        if not prompt:
            raise RuntimeError("prompt is required for LTX 2.3 Fast Text-to-Video")
