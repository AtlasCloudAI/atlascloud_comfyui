...
class AtlasLightricksLtx2FastTextToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "duration": ([6, 8, 10, 12, 14, 16, 18, 20], {"default": 6, "tooltip": "The duration of the generated media in seconds."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Ltx-2 Fast Text-to-video": AtlasLightricksLtx2FastTextToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Ltx-2 Fast Text-to-video": "AtlasCloud Ltx-2 Fast Text-to-video"}
