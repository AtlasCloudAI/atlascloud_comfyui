...
class AtlasAlibabaWan21T2v720pLora:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.1/t2v-720p-lora",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.1 t2v 720p Lora": AtlasAlibabaWan21T2v720pLora}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.1 t2v 720p Lora": "AtlasCloud Wan-2.1 t2v 720p Lora"}
