...
class AtlasAlibabaWan25TextToVideoFast:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.5 Text-to-video Fast": AtlasAlibabaWan25TextToVideoFast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.5 Text-to-video Fast": "AtlasCloud Wan-2.5 Text-to-video Fast"}
