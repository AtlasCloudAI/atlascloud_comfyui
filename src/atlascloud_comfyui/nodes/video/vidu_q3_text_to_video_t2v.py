    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (['16:9', '9:16', '4:3', '3:4', '1:1'], {"default": '4:3', "tooltip": "The aspect ratio of the generated media."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Vidu Q3 Text-to-video": AtlasViduQ3TextToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Vidu Q3 Text-to-video": "AtlasCloud Vidu Q3 Text-to-video"}
