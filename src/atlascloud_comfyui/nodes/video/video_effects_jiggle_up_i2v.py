...
class AtlasVideoEffectsJiggleUp:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Jiggle Up": AtlasVideoEffectsJiggleUp}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Jiggle Up": "AtlasCloud Jiggle Up"}
