...
class AtlasKwaivgiKlingV25TurboProImageToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "negative_prompt": ("STRING", {"multiline": True, "default": "", "tooltip": "The negative prompt for the generation. max length 2500"}),
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Kling v2.5 Turbo Pro Image-to-video": AtlasKwaivgiKlingV25TurboProImageToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Kling v2.5 Turbo Pro Image-to-video": "AtlasCloud Kling v2.5 Turbo Pro Image-to-video"}
