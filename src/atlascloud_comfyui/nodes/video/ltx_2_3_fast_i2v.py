...
class AtlasLtx23FastImageToVideo:
    """
    ComfyUI Node: AtlasCloud LTX 2.3 Fast Image-to-Video (remote API)
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "duration": ([6, 8, 10, 12, 14, 16, 18, 20], {"default": 6, "tooltip": "Video length in seconds"}),
                ...
                "generate_audio": ("BOOLEAN", {"default": False, "tooltip": "Generate a synchronized audio track"}),
    ...
    def run(
        ...
        if not image:
            raise RuntimeError("image is required for LTX 2.3 Fast Image-to-Video")

        client = atlas_client.client

        payload: Dict[str, Any] = {
            "model": "ltx/ltx-2.3-fast/image-to-video",
            "image": image,
