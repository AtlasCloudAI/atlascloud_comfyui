...
class AtlasPixversePixverseV45T2v:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (['16:9', '4:3', '1:1', '3:4', '9:16'], {"default": '16:9', "tooltip": "Video aspect ratio (16:9, 4:3, 1:1, 3:4, 9:16)."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Pixverse v4.5 t2v": AtlasPixversePixverseV45T2v}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Pixverse v4.5 t2v": "AtlasCloud Pixverse v4.5 t2v"}
