...
class AtlasLtx25ProImageToVideo:
    """
    ComfyUI Node: AtlasCloud LTX 2.5 Pro Image-to-Video (remote API)
    ...
    def run(
        ...
        if not image:
            raise RuntimeError("image is required for LTX 2.5 Pro Image-to-Video")
