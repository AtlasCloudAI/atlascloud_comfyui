...
class AtlasAlibabaWan2114bVace:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.1-14b-vace",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.1 14b Vace": AtlasAlibabaWan2114bVace}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.1 14b Vace": "AtlasCloud Wan-2.1 14b Vace"}
