...
class AtlasKwaivgiKlingV21T2vMaster:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (['16:9', '9:16', '1:1'], {"default": '16:9', "tooltip": "Generated video aspect ratio."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Kling v2.1 t2v Master": AtlasKwaivgiKlingV21T2vMaster}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Kling v2.1 t2v Master": "AtlasCloud Kling v2.1 t2v Master"}
