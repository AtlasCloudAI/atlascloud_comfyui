...
class AtlasVideoEffectsFishermen:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Fishermen": AtlasVideoEffectsFishermen}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Fishermen": "AtlasCloud Fishermen"}
