...
class AtlasAlibabaWan21I2v720pUltraFast:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.1/i2v-720p-ultra-fast",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 720p Ultra Fast": AtlasAlibabaWan21I2v720pUltraFast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 720p Ultra Fast": "AtlasCloud Wan-2.1 i2v 720p Ultra Fast"}
