...
class AtlasMinimaxHailuo02T2vStandard:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hailuo 02 t2v Standard": AtlasMinimaxHailuo02T2vStandard}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hailuo 02 t2v Standard": "AtlasCloud Hailuo 02 t2v Standard"}
