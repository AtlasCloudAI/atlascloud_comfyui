    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (['auto', '16:9', '9:16', '1:1'], {"default": 'auto', "tooltip": "Aspect ratio of the generated video. If 'auto', the aspect ratio will be determined automatically based on the input image."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Magi-1 24b": AtlasAtlascloudMagi124b}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Magi-1 24b": "AtlasCloud Magi-1 24b"}
