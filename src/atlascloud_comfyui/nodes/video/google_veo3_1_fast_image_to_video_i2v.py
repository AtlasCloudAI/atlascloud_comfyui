...
class AtlasGoogleVeo31FastImageToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "duration": ([8, 4, 6], {"default": 4, "tooltip": "The duration of the generated media in seconds."}),
                "aspect_ratio": (['16:9', '9:16'], {"default": '16:9', "tooltip": "The aspect ratio of the generated media."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Veo3.1 Fast Image-to-video": AtlasGoogleVeo31FastImageToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Veo3.1 Fast Image-to-video": "AtlasCloud Veo3.1 Fast Image-to-video"}
