...
class AtlasAlibabaWan21I2v720pLora:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.1/i2v-720p-lora",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 720p lora": AtlasAlibabaWan21I2v720pLora}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 720p lora": "AtlasCloud Wan-2.1 i2v 720p lora"}
