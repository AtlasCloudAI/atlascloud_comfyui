...
class AtlasKwaivgiKlingEffects:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Kling Effects": AtlasKwaivgiKlingEffects}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Kling Effects": "AtlasCloud Kling Effects"}
