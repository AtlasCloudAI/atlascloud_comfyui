...
class AtlasGoogleVeo31FastTextToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (['16:9', '9:16'], {"default": '16:9', "tooltip": "Aspect ratio of the video."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Veo3.1 Fast Text-to-video": AtlasGoogleVeo31FastTextToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Veo3.1 Fast Text-to-video": "AtlasCloud Veo3.1 Fast Text-to-video"}
