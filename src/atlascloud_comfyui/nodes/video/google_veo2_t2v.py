    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "duration": ([5, 6, 7, 8], {"default": 5, "tooltip": "The duration of the generated media in seconds."}),
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Veo2": AtlasGoogleVeo2}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Veo2": "AtlasCloud Veo2"}
