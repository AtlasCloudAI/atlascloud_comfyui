...
class AtlasGoogleVeo3ImageToVideo:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Veo3 Image-to-Video": AtlasGoogleVeo3ImageToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Veo3 Image-to-Video": "AtlasCloud Veo3 Image-to-Video"}
