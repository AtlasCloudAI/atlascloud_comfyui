...
class AtlasAlibabaWan21I2v480pLora:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.1/i2v-480p-lora",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 480p lora": AtlasAlibabaWan21I2v480pLora}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.1 i2v 480p lora": "AtlasCloud Wan-2.1 i2v 480p lora"}
