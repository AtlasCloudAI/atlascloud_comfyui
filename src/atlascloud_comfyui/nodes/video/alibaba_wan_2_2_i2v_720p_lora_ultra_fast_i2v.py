...
class AtlasAlibabaWan22I2v720pLoraUltraFast:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "prompt": ("STRING", {"multiline": True, "default": "", "tooltip": "prompt"}),
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.2/i2v-720p-lora-ultra-fast",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.2 i2v 720p Lora Ultra Fast": AtlasAlibabaWan22I2v720pLoraUltraFast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.2 i2v 720p Lora Ultra Fast": "AtlasCloud Wan-2.2 i2v 720p Lora Ultra Fast"}
