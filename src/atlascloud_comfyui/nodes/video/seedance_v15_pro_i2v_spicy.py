...
class AtlasSeedanceV15ProImageToVideoSpicy:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "resolution": (
                    ["720p", "480p", "1080p"],
                    {"default": "720p", "tooltip": "Resolution preset"},
                ),
    ...
    def run(
        ...
        if not (image or "").strip():
            raise RuntimeError("image is required for Seedance V1.5 Pro Image-to-Video (Spicy)")
