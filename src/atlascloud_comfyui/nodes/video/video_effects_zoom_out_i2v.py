...
class AtlasVideoEffectsZoomOut:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Zoom Out": AtlasVideoEffectsZoomOut}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Zoom Out": "AtlasCloud Zoom Out"}
