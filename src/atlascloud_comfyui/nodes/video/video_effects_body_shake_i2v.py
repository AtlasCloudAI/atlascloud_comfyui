...
class AtlasVideoEffectsBodyShake:
    ...
    def run(
        ...
        payload = {
            "model": "video-effects/body-shake",
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Body Shake": AtlasVideoEffectsBodyShake}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Body Shake": "AtlasCloud Body Shake"}
