...
class AtlasAlibabaWan22T2v5b720p:
    ...
    def run(
        ...
        payload = {
            "model": "alibaba/wan-2.2/t2v-5b-720p",
            "prompt": prompt,
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Wan-2.2 t2v 5b 720p": AtlasAlibabaWan22T2v5b720p}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Wan-2.2 t2v 5b 720p": "AtlasCloud Wan-2.2 t2v 5b 720p"}
