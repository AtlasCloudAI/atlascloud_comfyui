...
class AtlasKwaivgiKlingV26StdAvatar:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Kling v2.6 Std Avatar": AtlasKwaivgiKlingV26StdAvatar}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Kling v2.6 Std Avatar": "AtlasCloud Kling v2.6 Std Avatar"}
