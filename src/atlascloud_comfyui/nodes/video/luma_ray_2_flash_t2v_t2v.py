...
NODE_CLASS_MAPPINGS = {"AtlasCloud Ray 2 Flash t2v": AtlasLumaRay2FlashT2v}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Ray 2 Flash t2v": "AtlasCloud Ray 2 Flash t2v"}
