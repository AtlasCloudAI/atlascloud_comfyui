...
class AtlasMinimaxHailuo02Fast:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hailuo-02 Fast": AtlasMinimaxHailuo02Fast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hailuo-02 Fast": "AtlasCloud Hailuo-02 Fast"}
