...
class AtlasBytedanceSeedreamV3:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Seedream V3": AtlasBytedanceSeedreamV3}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Seedream V3": "AtlasCloud Seedream V3"}
