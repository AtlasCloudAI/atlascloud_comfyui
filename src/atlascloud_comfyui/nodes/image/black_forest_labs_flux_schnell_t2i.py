...
class AtlasBlackForestLabsFluxSchnell:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Schnell": AtlasBlackForestLabsFluxSchnell}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Schnell": "AtlasCloud Flux Schnell"}
