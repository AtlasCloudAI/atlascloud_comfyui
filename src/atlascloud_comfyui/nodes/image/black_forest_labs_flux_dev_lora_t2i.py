...
class AtlasBlackForestLabsFluxDevLora:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Dev Lora": AtlasBlackForestLabsFluxDevLora}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Dev Lora": "AtlasCloud Flux Dev Lora"}
