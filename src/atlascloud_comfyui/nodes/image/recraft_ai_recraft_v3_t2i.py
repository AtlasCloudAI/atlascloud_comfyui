...
NODE_CLASS_MAPPINGS = {"AtlasCloud Recraft v3": AtlasRecraftAiRecraftV3}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Recraft v3": "AtlasCloud Recraft v3"}
