...
class AtlasIdeogramAiIdeogramV3Balanced:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Ideogram v3 Balanced": AtlasIdeogramAiIdeogramV3Balanced}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Ideogram v3 Balanced": "AtlasCloud Ideogram v3 Balanced"}
