...
class AtlasAtlascloudHidreamI1Dev:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hidream i1 Dev": AtlasAtlascloudHidreamI1Dev}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hidream i1 Dev": "AtlasCloud Hidream i1 Dev"}
