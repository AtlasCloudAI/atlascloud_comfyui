...
class AtlasAtlascloudNetaLumina:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Neta Lumina": AtlasAtlascloudNetaLumina}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Neta Lumina": "AtlasCloud Neta Lumina"}
