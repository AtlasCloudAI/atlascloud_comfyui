...
class AtlasBlackForestLabsFluxDevLoraUltraFast:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "seed": ("INT", {"default": -1, "min": -1, "max": 2147483647, "tooltip": "Random seed (-1 for random)"}),
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Dev Lora Ultra Fast": AtlasBlackForestLabsFluxDevLoraUltraFast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Dev Lora Ultra Fast": "AtlasCloud Flux Dev Lora Ultra Fast"}
