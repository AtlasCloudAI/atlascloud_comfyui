    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "prompt": ("STRING", {"multiline": True, "default": "", "tooltip": "Prompts for generating images can be entered in either Chinese or English. It is recommended to keep the length ≤ 120 characters, with a maximum limit of 800 characters. If the prompt is too long, there is a chance of errors or failure to generate the image."}),
            },
            "optional": {
