...
class AtlasBlackForestLabsFluxKontextProTextToImage:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Kontext Pro Text-to-Image": AtlasBlackForestLabsFluxKontextProTextToImage}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Kontext Pro Text-to-Image": "AtlasCloud Flux Kontext Pro Text-to-Image"}
