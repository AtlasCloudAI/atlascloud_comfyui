...
class AtlasBytedanceSeedreamV4:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Seedream v4": AtlasBytedanceSeedreamV4}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Seedream v4": "AtlasCloud Seedream v4"}
