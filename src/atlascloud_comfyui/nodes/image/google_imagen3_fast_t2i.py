...
NODE_CLASS_MAPPINGS = {"AtlasCloud Image3 Fast": AtlasGoogleImagen3Fast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Image3 Fast": "AtlasCloud Image3 Fast"}
