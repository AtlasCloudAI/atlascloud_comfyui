...
class AtlasGoogleNanoBanana2TextToImage:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Nano Banana 2 Text-to-Image": AtlasGoogleNanoBanana2TextToImage}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Nano Banana 2 Text-to-Image": "AtlasCloud Nano Banana 2 Text-to-Image"}
