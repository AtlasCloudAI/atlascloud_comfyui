...
class AtlasAtlascloudHunyuanImage3:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Hunyuan Image 3": AtlasAtlascloudHunyuanImage3}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Hunyuan Image 3": "AtlasCloud Hunyuan Image 3"}
