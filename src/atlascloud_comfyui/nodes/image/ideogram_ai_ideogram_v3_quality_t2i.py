...
class AtlasIdeogramAiIdeogramV3Quality:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Ideogram v3 Quality": AtlasIdeogramAiIdeogramV3Quality}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Ideogram v3 Quality": "AtlasCloud Ideogram v3 Quality"}
