...
class AtlasBlackForestLabsFluxDev:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Dev": AtlasBlackForestLabsFluxDev}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Dev": "AtlasCloud Flux Dev"}
