...
class AtlasBlackForestLabsFluxSchnellLora:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Schnell Lora": AtlasBlackForestLabsFluxSchnellLora}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Schnell Lora": "AtlasCloud Flux Schnell Lora"}
