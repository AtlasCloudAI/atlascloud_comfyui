...
class AtlasAlibabaQwenImageTextToImageMax:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Qwen-Image Text-to-image Max": AtlasAlibabaQwenImageTextToImageMax}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Qwen-Image Text-to-image Max": "AtlasCloud Qwen-Image Text-to-image Max"}
