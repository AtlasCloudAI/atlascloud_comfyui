...
class AtlasGoogleNanoBananaProTextToImage:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Nano Banana Pro Text-to-image": AtlasGoogleNanoBananaProTextToImage}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Nano Banana Pro Text-to-image": "AtlasCloud Nano Banana Pro Text-to-image"}
