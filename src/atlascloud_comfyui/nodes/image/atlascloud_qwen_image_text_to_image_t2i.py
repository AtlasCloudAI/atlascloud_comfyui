...
NODE_CLASS_MAPPINGS = {"AtlasCloud Qwen Image Text-to-image": AtlasAtlascloudQwenImageTextToImage}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Qwen Image Text-to-image": "AtlasCloud Qwen Image Text-to-image"}
