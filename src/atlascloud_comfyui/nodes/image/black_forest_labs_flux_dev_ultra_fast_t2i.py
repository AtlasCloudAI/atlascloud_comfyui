...
class AtlasBlackForestLabsFluxDevUltraFast:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Flux Dev Ultra Fast": AtlasBlackForestLabsFluxDevUltraFast}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Flux Dev Ultra Fast": "AtlasCloud Flux Dev Ultra Fast"}
