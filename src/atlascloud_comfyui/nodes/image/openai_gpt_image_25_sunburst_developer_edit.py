...
class AtlasOpenAIGPTImage25SunburstDeveloperEdit:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                # The developer tier exposes neither `quality` nor `mask`; the schema drops both.
                "size": (
    ...
    def run(
        ...
        payload: Dict[str, Any] = {
            "model": "openai/gpt-image-2.5-sunburst-developer/edit",
            "prompt": p,
            "images": image_list,
            "size": size,
