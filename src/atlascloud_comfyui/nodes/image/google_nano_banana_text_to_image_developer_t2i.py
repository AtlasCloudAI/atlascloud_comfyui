...
class AtlasGoogleNanoBananaTextToImageDeveloper:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Nano Banana Text-to-image Developer": AtlasGoogleNanoBananaTextToImageDeveloper}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Nano Banana Text-to-image Developer": "AtlasCloud Nano Banana Text-to-image Developer"}
