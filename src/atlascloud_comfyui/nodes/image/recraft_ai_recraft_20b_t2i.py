...
class AtlasRecraftAiRecraft20b:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Recraft 20b": AtlasRecraftAiRecraft20b}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Recraft 20b": "AtlasCloud Recraft 20b"}
