...
class AtlasGoogleNanoBananaProTextToImageDeveloper:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (['1:1', '3:2', '2:3', '3:4', '4:3', '4:5', '5:4', '9:16', '16:9', '21:9'], {"default": '1:1', "tooltip": "The aspect ratio of the generated media."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Nano Banana Pro Text-to-image Developer": AtlasGoogleNanoBananaProTextToImageDeveloper}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Nano Banana Pro Text-to-image Developer": "AtlasCloud Nano Banana Pro Text-to-image Developer"}
