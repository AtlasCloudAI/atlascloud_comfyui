...
class AtlasBytedanceSeedreamV4Sequential:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Seedream v4 Sequential": AtlasBytedanceSeedreamV4Sequential}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Seedream v4 Sequential": "AtlasCloud Seedream v4 Sequential"}
