...
NODE_CLASS_MAPPINGS = {"AtlasCloud Photon Flash": AtlasLumaPhotonFlash}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Photon Flash": "AtlasCloud Photon Flash"}
