...
class AtlasBytedanceSeedreamV50Lite:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "prompt": ("STRING", {"multiline": True, "default": "", "tooltip": "The positive prompt for the generation. Recommended length: under 600 English words."}),
            },
            "optional": {
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Seedream v5.0 Lite": AtlasBytedanceSeedreamV50Lite}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Seedream v5.0 Lite": "AtlasCloud Seedream v5.0 Lite"}
