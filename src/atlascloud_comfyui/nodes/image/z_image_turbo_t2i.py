...
NODE_CLASS_MAPPINGS = {"AtlasCloud Z-Image Turbo": AtlasZImageTurbo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Z-Image Turbo": "AtlasCloud Z-Image Turbo"}
