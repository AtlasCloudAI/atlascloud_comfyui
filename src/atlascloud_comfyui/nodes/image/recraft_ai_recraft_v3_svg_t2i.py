...
class AtlasRecraftAiRecraftV3Svg:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Recraft v3 Svg": AtlasRecraftAiRecraftV3Svg}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Recraft v3 Svg": "AtlasCloud Recraft v3 Svg"}
